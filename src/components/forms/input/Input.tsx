...
export function Input({ Icon, className, ...inputProps }: InputType) {
    const inputId = useId();
    return (
        <div className="flex flex-row-reverse items-center rounded-xl overflow-hidden ring-1 ring-slate-200 text-zinc-500 gap-3 px-4 has-[:focus]:ring-emerald-500 w-full">
